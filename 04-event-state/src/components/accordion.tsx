...
export default function Accordion() {
    ...
    return (
        ...
        >
            Dengan populasi sekitar 2 juta orang, Almaty adalah kota besar di Kazakhstan.
        ...
        >
            Nama "Almaty" berasal dari kata <span lang="KK-KZ">Anma</span>, dalam bahasa Kazakh yang berarti "apel"
            dan sering diterjemahkan sebagai "penuh dengan apel". Sebenarnya, wilayah sekitar Almaty dipercaya sebagai 
...
function Panel({title, children, isActive, onShow}) {
    return (
        <section className="panel border border-gray-700 p-2">
            ...
            onClick={onShow}>Tampilkan</button>)}
        </section>
    );
}